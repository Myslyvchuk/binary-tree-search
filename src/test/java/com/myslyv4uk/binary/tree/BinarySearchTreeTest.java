...
import com.myslyv4uk.binary.tree.BinaryTreeSearch;
import com.myslyv4uk.binary.tree.BinaryTreeSearchAlgorithm;
...
class BinarySearchTreeTest {
    ...
    private BinaryTreeSearch<Integer> tree = new BinaryTreeSearchAlgorithm<>();
    ...
    @Order(4)
    void of() {
        tree = BinaryTreeSearchAlgorithm.of(someElements);
    ...
    private void fillTestTree(Integer... elements) {
        tree = new BinaryTreeSearchAlgorithm<>();
